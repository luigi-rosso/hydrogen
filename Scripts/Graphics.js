...
export default class Graphics
{
	...
	// N.B. This method changed to pass in the startX as this is the 
	// tab basis. It must be the left margin from which the text (even if culled) starts.
	// This is only really pertinent for when you have tabs in the text.
	@bind
	drawText(startX, x, y, t, offset, lastChar)
	{
		offset |= 0;
